...
exports.backupAlbumJson = async (albumId) => {
  const dir = path.join(pathPublic, '/albums', albumId);
...
exports.loadAlbumJson = async (albumId) => {
  const filePath = path.join(pathPublic, '/albums', albumId, JSON_FILE_NAME);
...
exports.getAlbumImgs = (albumId) => {
  const filePath = path.join(pathPublic, '/albums', albumId, 'img/*');
